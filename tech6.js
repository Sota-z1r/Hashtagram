                ...
                .then((result) => {
                    ...
                    fetch(url3)
                        ...
                        .then((result) => {
                            ...
                            //after
                            let after = dataMedias[t].paging.cursors.after;                            
                            ...
                            async function myasync(after2) {
                                ...
                                await fetch(url4)
                                    ...
                                    .then((result) => {
                                        ...
                                        //console.log(result);
                                        dataMedia2 = result;
                                        Array.prototype.push.apply(dataMedias[t].data, result.data);
                                        console.log(dataMedias[t]);
                                        ...
                                        if (dataMedias[t].data.length < 200) {
                                            myasync(after);
                                        }
                                        return;
                                    })
